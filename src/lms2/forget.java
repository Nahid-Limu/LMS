...
public class forget extends javax.swing.JFrame {
    ...
    public void search() {
        ...
        String sql = "SELECT * FROM `singup` WHERE un ='" + sText + "' ";
    ...
    public void retrive() {
        ...
        String sql = "SELECT * FROM `singup` WHERE un ='" + sText + "' AND ans ='" + ans + "' ";
        try {
            pst = con.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 255, 255)), "Forget Password", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(204, 0, 0))); // NOI18N
        ...
        again.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        again.setText("Retrive");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(again, javax.swing.GroupLayout.DEFAULT_SIZE, 82, Short.MAX_VALUE)
